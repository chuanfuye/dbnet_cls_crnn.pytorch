...
def init_args():
    ...
    parser.add_argument('--model_path', default=r'output/DBNet_resnet18_FPN_DBHead/checkpoint/model_latest.pth', type=str)
...
if __name__ == '__main__':
    ...
    from utils.util import draw_bbox, get_file_list, save_result, show_img
