...
import lib.config.alphabets_sfzid as alphabets
import yaml
...
def parse_arg():
    ...
    parser.add_argument('--cfg', help='experiment configuration filename', type=str,
                        default='lib/config/sfzid_config.yaml')
    parser.add_argument('--image_path', type=str, default='images/numberstr2.jpg', help='the path to your image')
    parser.add_argument('--checkpoint', type=str, default='output/sfzid/crnn/checkpoints/checkpoint_best.pth',
