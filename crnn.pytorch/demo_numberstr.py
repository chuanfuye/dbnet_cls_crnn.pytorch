...
import lib.config.alphabets_numberstr as alphabets
import yaml
...
def parse_arg():
    ...
    parser.add_argument('--cfg', help='experiment configuration filename', type=str,
                        default='lib/config/numberstr_config.yaml')
    parser.add_argument('--image_path', type=str, default='images/09.jpg', help='the path to your image')
    parser.add_argument('--checkpoint', type=str, default='output/numberstr/crnn/checkpoints/checkpoint_best.pth',
