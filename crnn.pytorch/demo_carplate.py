...
import lib.config.alphabets_carplate as alphabets
import yaml
...
def parse_arg():
    ...
    parser.add_argument('--cfg', help='experiment configuration filename', type=str,
                        default='lib/config/carplate_config.yaml')
    parser.add_argument('--image_path', type=str, default='images/test_carplate6.jpg', help='the path to your image')
    parser.add_argument('--checkpoint', type=str, default='output/carplate/crnn/checkpoints/checkpoint_best.pth',
...
def recognition(config, img, model, converter, device):
    ...
    img = np.reshape(img, (config.MODEL.IMAGE_SIZE.H, w_cur,c))
